...
fn_TPM_upd = fullfile(spm('dir'),'tpm','eTPM.nii');
for ii=1:6
...
spm_check_registration(...
    ...
    fullfile(spm('dir'),'tpm','eTPM.nii,1'),...
    fullfile(spm('dir'),'tpm','eTPM.nii,2'),...
    fullfile(spm('dir'),'tpm','eTPM.nii,3'),...
    fullfile(spm('dir'),'tpm','eTPM.nii,4'),...
    fullfile(spm('dir'),'tpm','eTPM.nii,5'),...
    fullfile(spm('dir'),'tpm','eTPM.nii,6'),...
    fullfile(spm('dir'),'tpm','fixingTPM','nwTPM_sl2.nii,1'),...
    fullfile(spm('dir'),'tpm','fixingTPM','nwTPM_sl2.nii,2'),...
    fullfile(spm('dir'),'tpm','fixingTPM','nwTPM_sl2.nii,3'),...
    fullfile(spm('dir'),'tpm','fixingTPM','nwTPM_sl2.nii,4'),...
    fullfile(spm('dir'),'tpm','fixingTPM','nwTPM_sl2.nii,5'),...
    fullfile(spm('dir'),'tpm','fixingTPM','nwTPM_sl2.nii,6')...
    );
